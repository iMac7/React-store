...
export default class Navbar extends Component {
  ...
  toggle(){
    return this.setState((currentstate) => {return {open: !currentstate.open }})
  }
  ...
  <>
    <nav>
        ...
        <ul>
          {
            this.props.categories.map(category => {return (
              <React.Fragment key={category.name}>
                ...
                <li className={category.name === this.props.selected? styles.active : ''}
      ...
      <Link to="/">
        ...
        width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M36.0988 34.6014C36.1313 34.9985 35.8211 35.339 35.4268 35.339H5.59438C5.2009 35.339 4.89092 35.0002 4.92208 34.6037L7.06376 7.34717C7.09168 6.9927 7.38426 6.71973 7.73606 6.71973H33.1958C33.5468 6.71973 33.8391 6.99161 33.868 7.34499L36.0988 34.6014Z" fill="url(#paint0_linear_150_357)"/>
      ...
      <div>
        <div className={styles.cart}>
          <p onClick={() => this.toggle()}>{this.props.selectedCurrency} &nbsp; 
            <svg style={this.state.open ? {"transform":"rotate(180deg)"} : {}}
          ...
          <svg id={styles.cart} onClick={() =>this.props.toggleCart() } width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={styles.number}>{this.props.cart.length}</div>
        </div>
       ...
       {  this.state.open &&
        <ul className={styles.currencies}>
          ...
          {this.props.currencies.map(currency => (
            <li 
            className={this.props.selectedCurrency === currency.symbol? styles.selected : ''}
            key={currency.symbol}
    ...
    { this.props.cartIsOpen && <Modal cart={this.props.cart}
